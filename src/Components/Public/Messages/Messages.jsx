        ...
        <div className={m.Messages}>
        	...
        	<div className={m.MessagesItem}>
	        	<div className={m.Users}>
					...
					<UserAccount name='chloe grace moretz' id='chloe_grace_moretz' img='https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRxBicNkB8tUUZL03hVa8D_8Ss_ArdwyxeXxEjBWKPO4BuxFALI'/>
