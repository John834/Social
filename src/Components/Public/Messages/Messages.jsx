...
const Messages = () => {
	...
	let UserData = [
		...
		{id: 'Tom_Cruise', name: 'Tom Cruise', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTkWcbTxbsZdB_hTweA4oP6ZC8EbDY1EACOcpsgteEQN1qX1okp'},
		{id: 'Johnny_Depp', name: 'Johnny Depp', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSmNe1tcbNU_9Hhw5a2ERjURppxAceLCdLqm-O30Ei_iAjks_II'},
		...
		{id: 'Gal_Gadot', name: 'Gal Gadot', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQpbfDJceHGrtG8ayArCf3VF8ijxeH94vzsQ0gJ-cItYuK3xSh5'}
	]
	let MessageData = [
		{Message: 'Hello'},
		{Message: 'How are you?'}
        ...
        <div className={m.Messages}>
        	...
        	<div className={m.MessagesItem}>
	        	<div className={m.Users}>
					...
					<UserAccount name={UserData[4].name} id={UserData[4].id} img={UserData[4].img} />
					<UserAccount name={UserData[5].name} id={UserData[5].id} img={UserData[5].img} />
					<UserAccount name={UserData[6].name} id={UserData[6].id} img={UserData[6].img} />
